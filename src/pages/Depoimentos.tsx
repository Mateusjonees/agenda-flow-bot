...
export default function Depoimentos() {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <a href="https://wa.me/554899075189?text=Olá,%20gostaria%20de%20conhecer%20o%20Foguete%20Gestão" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-all hover:scale-110">
      ...
      <section className="pt-24 pb-12 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          delay: 0.1
            ...
            {stats.map((stat, index) => <div key={index} className="bg-card backdrop-blur-sm rounded-xl p-4 border border-border text-center shadow-sm">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          duration: 0.5
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button size="lg" onClick={() => navigate("/auth?mode=signup")} className="bg-gradient-to-r from-primary to-orange-500 hover:from-primary/90 hover:to-orange-500/90 text-white font-semibold px-8">
                Começar Agora
              </Button>
