          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0">
                ...
                <span className="text-foreground font-semibold">gestão empresarial</span>
              </p>
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 md:gap-3">
                {guaranteeBadges.map((badge, i) => (
                  <div key={i} className="flex items-center gap-2 px-3 md:px-4 py-2 md:py-2.5 glass rounded-full">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button
                  ...
                  className="h-12 md:h-14 px-6 md:px-8 text-base md:text-lg gap-3 shadow-xl bg-primary"
                >
                ...
                <Button
                  ...
                  className="h-12 md:h-14 px-6 md:px-8 text-base md:text-lg gap-3 glass"
                >
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center bg-card rounded-3xl shadow-2xl p-8 md:p-12 lg:p-16 border">
            ...
            <Button
              size="lg"
              onClick={handleGetStarted}
              className="h-14 md:h-16 px-8 md:px-10 text-base md:text-lg gap-3 shadow-xl bg-primary"
            >
