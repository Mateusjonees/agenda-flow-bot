...
import { Phone, Mail, FileText, MoreVertical, Pencil, Trash2, CreditCard, Maximize2, Minimize2, User, X, ListTodo, CalendarPlus, Sparkles } from "lucide-react";
...
export const CustomerDetailsSheet = ({
  ...
  // Calcular largura quando AI está ativo (desktop)
  const contentWidth = !isMobile && showAIAssistant ? Math.max(width, 800) : width;
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent 
        ...
        style={!isMobile && !isExpanded ? { width: `${contentWidth}px`, maxWidth: '100vw' } : undefined}
      >
        {/* Resize handle */}
        {!isMobile && open && (
          <div
        ...
        {/* Layout principal: conteúdo + painel IA lado a lado */}
        <div className="flex flex-1 overflow-hidden">
          {/* Coluna principal do cliente */}
          <div className={`flex flex-col flex-1 min-w-0 ${showAIAssistant && !isMobile ? 'max-w-[55%]' : ''}`}>
            {/* Header */}
              ...
              <div className="flex items-center gap-2 mt-3">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-48">
                    ...
                    <DropdownMenuItem onClick={() => setShowAIAssistant(true)}>
          ...
          {/* Painel de IA integrado (lado a lado no desktop, overlay no mobile) */}
          <AnimatePresence>
            {showAIAssistant && customer && (
              isMobile ? (
                // Mobile: overlay full
