...
import { Phone, Mail, MapPin, FileText, MoreVertical, Pencil, Trash2, Plus, Calendar, ClipboardList, CreditCard, Maximize2, Minimize2, GripVertical, User, X, ListTodo, CalendarPlus, Sparkles } from "lucide-react";
...
export const CustomerDetailsSheet = ({
  ...
  return (
    <>
          ...
          <SheetHeader className="px-4 py-3 border-b bg-muted/30 flex-shrink-0">
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex items-center gap-1">
                {/* Botão IA - Análise do Cliente */}
                <Button
                  variant="ghost"
                  size="icon"
                  onClick={() => setShowAIAssistant(true)}
                  className="h-8 w-8 text-purple-600 hover:text-purple-700 hover:bg-purple-100 dark:hover:bg-purple-900"
                  title="Analisar cliente com IA"
                >
      ...
      {/* AI Assistant contextualizado para o cliente */}
