      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-sm mx-auto">
          ...
          <a
            ...
            className="mt-6 flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20BD5A] text-white font-medium py-3 px-6 rounded-full transition-colors shadow-lg"
          >
