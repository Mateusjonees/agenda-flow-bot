...
import { Rocket, Calendar, Users, DollarSign, BarChart3, Star, CheckCircle2, ArrowRight, Sparkles, Shield, Clock, TrendingUp, HeadphonesIcon, Lock, Zap, Award, MessageCircle, ChevronDown, Check, Quote, Menu, X, Scissors, Dumbbell, Heart, Stethoscope, PawPrint, Building2, Smartphone, CreditCard, Wallet, CalendarCheck, XCircle, Package, FileText, TrendingDown, Target } from "lucide-react";
...
const Landing = () => {
  ...
  const pricingPlans = [{
    ...
    features: ["Até 100 agendamentos/mês", "Gestão de clientes ilimitada", "WhatsApp automático", "Controle financeiro básico", "Suporte por email"],
    popular: false
  }, {
    name: "Professional",
    price: "R$ 197",
    ...
    features: ["Agendamentos ilimitados", "Todas as funcionalidades", "Relatórios avançados", "Propostas profissionais", "Multi-usuários (até 5)", "Suporte prioritário", "Integração com PIX"],
    popular: true
  }, {
    name: "Enterprise",
    price: "Customizado",
    ...
    features: ["Tudo do Professional", "Usuários ilimitados", "API personalizada", "Treinamento dedicado", "Suporte 24/7", "Gerente de conta", "SLA garantido"],
    popular: false
  }];
  const faqs = [{
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background">
      ...
      <a href="https://wa.me/5548988430812?text=Olá,%20gostaria%20de%20conhecer%20o%20Foguete%20Gestão" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 animate-fade-in group" aria-label="Fale conosco no WhatsApp">
      ...
      <header className="border-b bg-card/95 backdrop-blur-lg sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img alt="Foguete" className="h-20 w-auto dark:hidden transition-transform duration-300 hover:scale-110 hover:rotate-6" src="/lovable-uploads/80412b3c-5edc-43b9-ab6d-a607dcdc2156.png" />
            <img src={logoAntigo} alt="Foguete" className="h-20 w-auto hidden dark:block" />
            <span className="text-xl font-bold text-foreground"></span>
          </div>

          {/* Desktop Navigation */}
          <nav className="hidden md:flex items-center gap-6">
            <button onClick={() => scrollToSection("home")} className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors relative group">
              Início
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary transition-all group-hover:w-full"></span>
            </button>
            <button onClick={() => scrollToSection("features")} className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors relative group">
              Recursos
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary transition-all group-hover:w-full"></span>
            </button>
            <button onClick={() => scrollToSection("testimonials")} className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors relative group">
              Depoimentos
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary transition-all group-hover:w-full"></span>
            </button>
            <button onClick={() => scrollToSection("pricing")} className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors relative group">
              Preços
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary transition-all group-hover:w-full"></span>
            </button>
            <button onClick={() => scrollToSection("faq")} className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors relative group">
              FAQ
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary transition-all group-hover:w-full"></span>
            </button>
          </nav>
          ...
          <div className="flex items-center gap-3">
            <ThemeToggle />
            {!isAuthenticated ? <>
                <Button onClick={() => navigate("/auth")} variant="ghost" className="hidden md:flex">
                  Entrar
                </Button>
                <Button onClick={() => navigate("/auth")} className="hidden md:flex gap-2 bg-[#E31E24] hover:bg-[#C41A1F] text-white">
                  Começe Grátis
                  <ArrowRight className="w-4 h-4" />
                </Button>
              </> : <Button onClick={() => navigate("/dashboard")} className="hidden md:flex gap-2">
                Ir para Dashboard
                <ArrowRight className="w-4 h-4" />
              </Button>}
        ...
        {/* Mobile Navigation */}
        {mobileMenuOpen && <div className="md:hidden border-t bg-card">
            <nav className="container mx-auto px-4 py-4 flex flex-col gap-4">
              ...
              <div className="pt-2 border-t space-y-2">
                {!isAuthenticated ? <>
                    <Button onClick={() => navigate("/auth")} className="w-full gap-2 bg-[#E31E24] hover:bg-[#C41A1F] text-white">
                      Começe Grátis
                      <ArrowRight className="w-4 h-4" />
                    </Button>
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center space-y-8 mb-16">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto animate-fade-in">
              Sistema completo para salões, clínicas, barbearias e prestadores de serviço. Gerencie agendamentos,
              clientes, finanças e muito mais em um só lugar.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-6">
              ...
              return <div key={index} className="flex items-center gap-2 px-4 py-2 bg-card border border-border rounded-full shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 animate-fade-in">
              <Button size="lg" onClick={handleGetStarted} className="h-14 px-8 text-base gap-2 shadow-lg hover:shadow-xl transition-all bg-[#E31E24] hover:bg-[#C41A1F] text-white">
                {isAuthenticated ? "Acessar Dashboard" : "Começar Teste Grátis"}
                <Rocket className="w-5 h-5" />
              </Button>
              <Button size="lg" variant="outline" onClick={() => window.open("https://wa.me/5548988430812?text=Olá,%20gostaria%20de%20conhecer%20o%20Foguete%20Gestão", "_blank")} className="h-14 px-8 text-base gap-2">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 pt-4 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-primary" />7 dias grátis
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-primary" />
          ...
          <div className="max-w-4xl mx-auto mt-16">
            <Carousel className="w-full">
              <CarouselContent>
                {screenshots.map((screenshot, index) => <CarouselItem key={index}>
                    <div className="p-1">
                      <Card className="border-2">
                        <CardContent className="flex aspect-video items-center justify-center p-6 bg-gradient-to-br from-muted/50 to-muted/20">
                          <div className="text-center space-y-4">
                            ...
                            <div>
                              <h3 className="text-2xl font-bold text-foreground mb-2">{screenshot.title}</h3>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Perfeito para seu segmento</h2>
            <p className="text-lg text-muted-foreground">Funcionalidades personalizadas para cada tipo de negócio</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {useCases.map((useCase, index) => {
            const Icon = useCase.icon;
            return <Card key={index} className="border-2 hover:border-primary/50 transition-all hover:shadow-lg group">
                  <CardContent className="p-6 text-center px-[2px]">
      ...
      <section id="features" className="container mx-auto px-4 py-20 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Tudo que você precisa</h2>
            <p className="text-lg text-muted-foreground">Funcionalidades completas para transformar sua gestão</p>
          </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Por que escolher o Foguete?</h2>
            <p className="text-lg text-muted-foreground">Mais de 5.000 empresas já confiam no Foguete</p>
          </div>

          <div className="grid md:grid-cols-2 gap-4">
            {benefits.map((benefit, index) => <div key={index} className="flex items-center gap-3 p-4 bg-card rounded-lg border hover:border-primary/50 transition-colors">
      ...
      <section className="container mx-auto px-4 py-20 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">Veja o impacto que o Foguete pode ter na sua empresa</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {roiStats.map((stat, index) => {
            const Icon = stat.icon;
            return <Card key={index} className="border-2 hover:border-primary/50 transition-all hover:shadow-xl group">
                  <CardContent className="p-6 text-center py-[22px]">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h3 className="text-2xl font-bold text-foreground mb-6">Confiança e Segurança Garantidas</h3>
          </div>
      ...
      <section className="container mx-auto px-4 py-20 bg-gradient-to-br from-primary/10 via-accent/10 to-secondary/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Pronto para transformar seu negócio?</h2>
      ...
      <section id="testimonials" className="container mx-auto px-4 py-20 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">Histórias reais de quem transformou seu negócio</p>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            {allTestimonials.map((testimonial, index) => <Card key={index} className="border-2 hover:border-primary/50 transition-all hover:shadow-lg">
      ...
      <section className="container mx-auto px-4 py-20 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Integrações Poderosas</h2>
            <p className="text-lg text-muted-foreground">Conecte o Foguete com as ferramentas que você já usa</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            return <Card key={index} className="border-2 hover:border-primary/50 transition-all hover:shadow-lg group">
                  <CardContent className="p-6 flex gap-4 py-[24px]">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Por que escolher o Foguete?</h2>
            <p className="text-lg text-muted-foreground">Veja como nos destacamos das soluções genéricas</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Acesse de qualquer lugar, sem instalação ou manutenção
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-2 border-muted py-0 px-0">
              <CardContent className="p-6 py-[24px]">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Sistemas antigos que precisam de manutenção constante
                    </p>
                  </div>
                </div>
              </CardContent>
      ...
      <section id="pricing" className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {pricingPlans.map((plan, index) => <Card key={index} className={`relative border-2 transition-all hover:shadow-xl ${plan.popular ? "border-primary shadow-lg scale-105" : "border-border hover:border-primary/50"}`}>
                ...
                <CardContent className="p-8 py-[32px]">
                  <h3 className="text-2xl font-bold text-foreground mb-2">{plan.name}</h3>
                  <p className="text-sm text-muted-foreground mb-6">{plan.description}</p>
                  {plan.name === "Professional" && <div className="mb-4">
                      <Badge className="bg-accent/20 text-accent-foreground border-accent/30">
                        <TrendingUp className="w-3 h-3 mr-1" />
                        Economize 30%
                      </Badge>
                    </div>}
                  {plan.name === "Enterprise" && <div className="mb-4">
                  ...
                  <Button onClick={handleGetStarted} className="w-full mb-6" variant={plan.popular ? "default" : "outline"}>
      ...
      <section id="faq" className="container mx-auto px-4 py-20 bg-muted/30">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">Tire suas dúvidas sobre o Foguete</p>
          </div>
          ...
          <div className="text-center mt-12">
            ...
            <Button variant="outline" className="gap-2" onClick={() => window.open("https://wa.me/5548990751889?text=Olá,%20preciso%20de%20suporte", "_blank")}>
      ...
      <section className="container mx-auto px-4 py-20">
        <Card className="max-w-4xl mx-auto relative overflow-hidden">
          ...
          <CardContent className="relative p-12 text-center py-[48px]">
            <Rocket className="w-16 h-16 text-primary mx-auto mb-6" />
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Pronto para decolar?</h2>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Junte-se a mais de 5.000 empresários que já transformaram sua gestão com o Foguete
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" onClick={handleGetStarted} className="h-14 px-8 text-base gap-2 shadow-lg">
                {isAuthenticated ? "Ir para Dashboard" : "Começar Teste Grátis"}
                <ArrowRight className="w-5 h-5" />
              </Button>
              <Button size="lg" variant="outline" onClick={() => scrollToSection("pricing")} className="h-14 px-8 text-base">
                Ver Planos e Preços
              </Button>
            </div>
            <p className="text-sm text-muted-foreground mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
            ...
            <div className="md:col-span-1">
              <div className="flex items-center gap-3 mb-4">
                <img src={foguetinho} alt="Foguete" className="h-10 w-auto dark:hidden transition-transform duration-300 hover:scale-110 hover:rotate-6" />
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="https://wa.me/5548988430812?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20o%20Foguete" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                    Contato
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  ...
                  <a href="https://wa.me/5548988430812?text=Olá,%20gostaria%20de%20conhecer%20o%20Foguete%20Gestão" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                    (48) 98843-0812
                  </a>
                </li>
                <li className="pt-2">
                  ...
                  <a href="https://wa.me/5548990751889?text=Olá,%20preciso%20de%20suporte" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                    (48) 99075-1889
                  </a>
                </li>
                <li className="pt-2">
